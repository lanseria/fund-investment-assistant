...
<template>
  <div class="p-4 lg:p-8 sm:p-6">
    ...
    <div v-else class="text-gray-400 py-20 text-center card">
      <div i-carbon-machine-learning-model class="text-5xl mx-auto mb-4 opacity-30" />
      <p>暂无 AI 账号排行数据</p>
    </div>
