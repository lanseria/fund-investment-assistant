 ...
 * daily: 忽略锚点; weekly: 1-5 (周一~周五); monthly: 1-28; biweekly: 忽略锚点。
 */
export function validatePlanRules(frequency: 'daily' | 'weekly' | 'biweekly' | 'monthly', anchorDay: number | null | undefined): string | null {
...
/** 基于当前时间推算首期(下次)扣款日 */
export function initialNextExecutionDate(frequency: 'daily' | 'weekly' | 'biweekly' | 'monthly', anchorDay: number | null | undefined): string {
